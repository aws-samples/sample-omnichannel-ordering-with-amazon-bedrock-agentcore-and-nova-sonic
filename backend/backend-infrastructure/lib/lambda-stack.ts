      ...
      [
        {
          ...
          reason: 'Wildcard permissions on DynamoDB table indexes are generated by grantReadData because the Customers table has the PhoneNumberIndex GSI. Permissions are scoped to the specific Customers table.',
        },
      ],
      true
    );
